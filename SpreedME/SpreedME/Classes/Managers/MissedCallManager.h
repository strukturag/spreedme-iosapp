...
@interface MissedCallManager : NSObject

+ (MissedCallManager *)sharedInstance; // Shared instance. You should not create your own instance although it is permitted now.
