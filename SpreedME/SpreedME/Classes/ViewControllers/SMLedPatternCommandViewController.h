...
@class SMLedPatternCommandViewController;
@protocol SMLedPatternCommandViewControllerDelegate <NSObject>
...
@interface SMLedPatternCommandViewController : UIViewController

@property (nonatomic, weak) id<SMLedPatternCommandViewControllerDelegate> delegate;
