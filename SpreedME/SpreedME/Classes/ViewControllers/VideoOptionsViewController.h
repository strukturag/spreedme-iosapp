...
@class VideoOptionsViewController;

@protocol VideoOptionsViewControllerDelegate <NSObject>
@optional
...
@protocol VideoOptionsViewControllerDataSource <NSObject>
@required
...
@property (nonatomic, weak) id<VideoOptionsViewControllerDelegate> delegate;
@property (nonatomic, weak) id<VideoOptionsViewControllerDataSource> datasource;

@property (nonatomic, strong) SMVideoSettings *userVideoSettings;
