...
typedef enum : NSUInteger {
    kSMLoginViewControllerUIStateAppVersionUnsupported,
    kSMLoginViewControllerUIStateNormal,
    kSMLoginViewControllerUIStateOwnCloud,
} SMLoginViewControllerUIState;
