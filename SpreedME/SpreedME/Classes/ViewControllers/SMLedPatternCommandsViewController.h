...
extern NSString * const LEDPreviewSuccededNotification;
extern NSString * const LEDPreviewSuccessUserInfoKey;
extern NSString * const LEDConfigurationHasBeenUpdatedNotification;
extern NSString * const LEDStatesUserInfoKey;
extern NSString * const LEDStatesUpdateSuccessUserInfoKey;

@class SMLedPatternCommandsViewController;
@protocol SMLedPatternCommandsViewControllerDelegate <NSObject>
...
@interface SMLedPatternCommandsViewController : UIViewController

@property (nonatomic, weak) id<SMLedPatternCommandsViewControllerDelegate> delegate;
