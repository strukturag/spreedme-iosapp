...
@interface RetainingView : UIView
@property (nonatomic, strong) id objectToRetain;
@end


@interface FlyOverAlert : NSObject
{
	RetainingView *_alertView;
}
...
// These methods have concrete implementation
...
- (CGPoint)centerViewForAnyOrientation;// This method assumes that view has been already rotated
