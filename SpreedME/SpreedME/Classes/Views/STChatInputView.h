...
#define kSTChatInputViewBackgroundColor             kSpreedMeNavigationBarBackgroundColor
#define kSTChatInputViewSendButtonTitleColor        kGreenSpreedStyleColor


@class STChatInputView;

@protocol STChatInputViewDelegate <NSObject>
@required
...
@interface STChatInputView : UIView <UITextViewDelegate>

@property (nonatomic, weak) id<STChatInputViewDelegate> delegate;
