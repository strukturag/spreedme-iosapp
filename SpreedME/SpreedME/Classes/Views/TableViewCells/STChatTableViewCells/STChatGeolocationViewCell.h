...
#define kSTChatGeolocationTVCBlueButtonColor               kSMBlueButtonColor
#define kSTChatGeolocationTVCBlueButtonSelectedColor       kSMBlueSelectedButtonColor


@class STChatGeolocationViewCell;

@protocol STChatGeolocationViewCellDelegate <NSObject>
@required
...
@interface STChatGeolocationViewCell : STChatGeneralTableViewCell
...
@property (nonatomic, strong, readonly) STFontAwesomeRoundedButton *showLocationButton;
